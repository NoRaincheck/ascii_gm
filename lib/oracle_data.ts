...
export function buildGenData(): Record<string, unknown> {
  ...
  const actionFocus = [
    "Seek", "Oppose", "Communicate", "Move", "Harm", "Create",
    "Reveal", "Command", "Take", "Protect", "Assist", "Transform", "Deceive",
  ];

  const topicFocus = [
    "Current Need", "Allies", "Community", "History", "Future Plans",
    "Enemies", "Knowledge", "Rumors", "A Plot Arc", "Recent Events",
  ...
  genData["virtue"] = [
    "Ambitious", "Courageous", "Disciplined", "Honorable", "Serene",
    "Merciful", "Humble", "Tolerant", "Gregarious", "Cautious",
  ].map((x) => x.padEnd(17, " "));

  genData["vice"] = [
    "Aggressive", "Bitter", "Craven", "Deceitful", "Greedy",
    "Vengeful", "Lazy", "Nervous", "Rude", "Vain",
  ].map((x) => x.padEnd(17, " "));
